...
198200,Cape Newenham LRRS Airport,3427,-162.06300354,58.646400451699996,10878.523714379604,-123.86942642142148,247956
    ...
    0 to 816 on groud at Alice Springs Airport  0 <= t < 816
    816 to 61068 in route from Alice Springs Airport to La Plata Airport 816 <= t < 61068
    61068 to 61648 on ground at La Plata Airport
    ...
    198200 to 247956 in route from Cape Newenham LRRS Airport to Alice Springs Airport
    ...
    public String toString() {
        return "Route{" + "wpts=" + wpts + ", lastSec=" + lastSec + ", numWpts=" + numWpts + ", offset=" + offset + ", id=" + id + '}';
    }
